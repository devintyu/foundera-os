  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-center gap-3">
        <div className="relative flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-[#00F0FF]/20 to-[#8B5CF6]/20">
          <Zap className="h-5 w-5 text-[#00F0FF]" />
          <span className="absolute -right-0.5 -top-0.5 h-2.5 w-2.5 rounded-full bg-[#00F0FF] shadow-[0_0_8px_rgba(0,240,255,0.6)]" />
        </div>
      ...
      <div className="glass-card rounded-2xl p-8">
        ...
        <button
          ...
          type="button"
          className="mb-6 flex w-full items-center justify-center gap-3 rounded-lg border border-[#1E1E2E] bg-[#1E1E2E]/50 px-4 py-3 text-sm font-medium transition-colors hover:bg-[#1E1E2E]"
        >
